...
public class gc_mosin_sniper_customModel implements IOverrideModel {
    ...
    public void render(float partialTicks, ItemTransforms.TransformType transformType, ItemStack stack, ItemStack parent, @Nullable LivingEntity entity, PoseStack poseStack, MultiBufferSource buffer, int light, int overlay)
    {
        ...
        poseStack.mulPose(Vector3f.ZN.rotationDegrees(-5F * cooldownSigma));
        poseStack.translate(0, 5.8 * 0.0625, 0);
        RenderUtil.renderModel(SpecialModels.GC_MOSIN_SNIPER_MAIN.getModel(), transformType, null, stack, parent, poseStack, buffer, light, overlay);
        ...
        {
            RenderUtil.renderModel(SpecialModels.GC_MOSIN_SNIPER_PARTS_MAIN.getModel(), transformType, null, stack, parent, poseStack, buffer, light, overlay);
        }

        poseStack.pushPose();
        poseStack.translate(0, -5.8 * 0.0625, 0);
        poseStack.mulPose(Vector3f.ZN.rotationDegrees(-90F * Math.min(boltPivot*2F,1)));
        poseStack.translate(0, 0, (boltMovement * 2.5) * 0.0625);
        poseStack.translate(0, 5.8 * 0.0625, 0);
        RenderUtil.renderModel(SpecialModels.GC_MOSIN_SNIPER_BOLT.getModel(), transformType, null, stack, parent, poseStack, buffer, light, overlay);
        poseStack.popPose();
