...
public class gc_rpg7_og7v_customModel implements IOverrideModel {
    ...
    public void render(float partialTicks, ItemTransforms.TransformType transformType, ItemStack stack, ItemStack parent, @Nullable LivingEntity entity, PoseStack poseStack, MultiBufferSource buffer, int light, int overlay)
    {
            ...
            {
                RenderUtil.renderModel(SpecialModels.GC_RPG7_SIGHTS_DOWN.getModel(), transformType, null, stack, parent, poseStack, buffer, light, overlay);
            }
            else
            {
                RenderUtil.renderModel(SpecialModels.GC_RPG7_SIGHTS_UP.getModel(), transformType, null, stack, parent, poseStack, buffer, light, overlay);
            }
