...
public class gc_fdi_prototype_000_customModel implements IOverrideModel {
    ...
    public void render(float partialTicks, ItemTransforms.TransformType transformType, ItemStack stack, ItemStack parent, @Nullable LivingEntity entity, PoseStack poseStack, MultiBufferSource buffer, int light, int overlay)
    {
        ...
        {
            RenderUtil.renderModel(SpecialModels.GC_FDI_PROTOTYPE_000_SIGHT_RAIL.getModel(), transformType, null, stack, parent, poseStack, buffer, light, overlay);
        }
        ...
        poseStack.translate(0, 5.8 * 0.0625, 0);
        RenderUtil.renderModel(SpecialModels.GC_FDI_PROTOTYPE_000_BOLT.getModel(), transformType, null, stack, parent, poseStack, buffer, light, overlay);
        poseStack.popPose();
    }
