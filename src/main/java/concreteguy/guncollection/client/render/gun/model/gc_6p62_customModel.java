...
public class gc_6p62_customModel implements IOverrideModel {
    ...
    {
        RenderUtil.renderModel(SpecialModels.GC_6P62_MAIN.getModel(), transformType, null, stack, parent, poseStack, buffer, light, overlay);
        ...
        poseStack.translate(0, 5.8 * 0.0625, 0);
        RenderUtil.renderModel(SpecialModels.GC_6P62_BOLT.getModel(), transformType, null, stack, parent, poseStack, buffer, light, overlay);
        poseStack.popPose();

        RenderUtil.renderModel(SpecialModels.GC_6P62_BIPOD.getModel(), transformType, null, stack, parent, poseStack, buffer, light, overlay);
